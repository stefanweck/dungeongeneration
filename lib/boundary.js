...
*
* @param {int} left - The left position of this boundary
* @param {int} top - The top position of this boundary
* @param {int} width - The width of this boundary
* @param {int} height - The height of this boundary
*/
Roguelike.Boundary = function(left, top, width, height){

    /*
    * @property {int} left - The left position of this boundary
    */
    this.left = left || 0;

    /*
    * @property {int} top - The top position of this boundary
    */
    this.top = top || 0;

    /*
    * @property {int} width - The width of this boundary
    */
    this.width = width || 0;

    /*
    * @property {int} height - The height of this boundary
    */
    this.height = height || 0;

    /*
    * @property {int} right - The right position of this boundary
    */
    this.right = (this.left + this.width);

    /*
    * @property {int} bottom - The bottom position of this boundary
    */
...
Roguelike.Boundary.prototype = {
    ...
    * @param {int} left - The left position of this boundary
    * @param {int} top - The top position of this boundary
    * @param {int} width - Optional: The width of this boundary
    * @param {int} height - Optional: The height of this boundary
    */
