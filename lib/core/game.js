...
Game.prototype = {
	...
	load: function(){
		...
		var assetsToLoader = ["assets/tilesets/dungeon.json", "assets/sprites/entities.json"];
	...
	update: function() {
		...
		this.world.pivot = new PIXI.Point(this.world.camera.position.x, this.world.camera.position.y);
