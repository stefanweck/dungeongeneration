...
Roguelike.Game.prototype = {
	...
	initialize: function() {
		...
		this.player = Roguelike.PlayerFactory.newPlayerWarrior(this, playerPosition);
		...
		//TODO: Don't do this here, it should only unlock if the keyboardComponent does something
		var that = this;
		window.addEventListener('keydown', function(){
			that.scheduler.unlock();
		}, false);
