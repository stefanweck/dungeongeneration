...
Roguelike.Game = function(userSettings) {
	...
	/**
	 * @property {Roguelike.TextLog} textLog - Reference to the TextLog object
	 */
	this.textLog = null;
...
Roguelike.Game.prototype = {
	...
	initialize: function() {
		...
		this.textLog = new Roguelike.TextLog();
	...
	initializeUI: function() {
		...
		var textLog = new Roguelike.UI.Container(
			new Roguelike.Vector2(0, 0)
		);

		this.UI.addElement(textLog);

		textLog.addElement(new Roguelike.UI.Element.Text(
			new Roguelike.Vector2(0, 0),
			"Hey"
		));
