	...
	update: function() {
		...
		for(var i = 0; i < entities.length; i++) {
			...
			for(var a = positionComponent.actions.length - 1; a >= 0; a--) {
				...
				var currentAction = positionComponent.actions[a];
				...
				switch(currentAction) {
					...
					case (37): //Left
						...
						newPosition = {x: positionComponent.position.x - 1, y: positionComponent.position.y};
					...
					case (38): //Down
						...
						newPosition = {x: positionComponent.position.x, y: positionComponent.position.y - 1};
