...
Roguelike.MapFactory.prototype = {
	...
	generateVerticalCorridor: function(x, y) {
		...
		//TODO: Maybe create a set tile to floor/wall/etc function, as this gets ugly really fast
		currentTile.type = 2;
		currentTile.tileRow = 0;
		currentTile.tileNumber = Roguelike.Utils.randomNumber(2, 5);
		currentTile.blockLight = false;
		...
		if(map.tiles[y + 1][x + 1].type === 0) {
			...
			map.tiles[y + 1][x + 1].tileRow = 0;
			map.tiles[y + 1][x + 1].tileNumber = 1;
