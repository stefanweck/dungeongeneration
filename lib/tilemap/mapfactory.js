...
Roguelike.MapFactory.prototype = {
	...
	generateDoors: function() {
		...
		for(var i = 0; i < this.possibleDoorLocations.length; i++){
			...
			if(tileLeft.type === 1 && tileRight.type === 1 && tileUp.type === 2 && tileDown.type === 2 && randomNumber > 60){
			...
			}else if(tileLeft.type === 2 && tileRight.type === 2 && tileUp.type === 1 && tileDown.type === 1 && randomNumber > 60){
