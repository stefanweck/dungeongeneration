...
MapDecorator.prototype = {
	...
	initialize: function() {
		...
		this.tileArray["wall_single_alone"] = [182, 222, 238, 239, 246, 252, 254, 255];
		this.tileArray["wall_pillar_left"] = [125, 204, 253];
		this.tileArray["wall_corner_left"] = [76, 92, 148, 156, 220, 221];
		this.tileArray["wall_top_end"] = [123, 187, 243, 249, 251];
		this.tileArray["wall_top_continue"] = [106, 122, 152, 154, 186, 192, 200, 202, 216, 218, 234, 250];
		this.tileArray["wall_corner_left_down"] = [25, 89, 57, 105, 121];
		this.tileArray["wall_left_continue"] = [24, 72, 80, 88];
		this.tileArray["wall_corner_right"] = [102, 134, 166, 183, 198, 230, 231, 247];
		this.tileArray["pillar_right"] = [32];
		this.tileArray["wall"] = [17, 33, 49, 68, 85, 101, 113, 117, 132, 149, 161, 165, 177, 181, 196, 212, 213, 228, 229, 245];
		this.tileArray["pillar_left"] = [16];
		this.tileArray["wall_corner_right_down"] = [35, 51, 145, 147, 163, 179];
