...
MapDecorator.prototype = {
	...
	initialize: function() {
		...
		this.tileArray["wall_single_alone"] = [124, 182, 222, 238, 239, 246, 252, 254, 255];
		...
		this.tileArray["wall_top_continue"] = [58, 106, 122, 152, 154, 186, 192, 200, 202, 216, 218, 234, 250];
		this.tileArray["wall_corner_left_down"] = [25, 89, 57, 97, 105, 113, 121];
		this.tileArray["wall_left_continue"] = [24, 72, 88];
		this.tileArray["wall_corner_right"] = [102, 134, 166, 183, 198, 228, 230, 231, 247];
