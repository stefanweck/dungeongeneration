...
MapDecorator.prototype = {
	...
	initialize: function() {
		...
		this.tileArray["wall_single"] = [255];
		this.tileArray["wall_single_alone"] = [238, 239, 254];
		this.tileArray["wall_pillar_left"] = [125, 204, 253];
		this.tileArray["wall_corner_left"] = [76, 92, 220];
		this.tileArray["wall_top_end"] = [123, 187, 251];
		this.tileArray["wall_top_continue"] = [122, 152, 186, 192, 200, 216, 218, 234, 250];
		this.tileArray["wall_corner_left_down"] = [25, 89, 57, 121];
		this.tileArray["wall_left_continue"] = [24, 72, 80, 88];
		this.tileArray["wall_corner_right"] = [134, 166, 230, 231, 247];
		this.tileArray["pillar_right"] = [32];
		this.tileArray["wall"] = [17, 33, 49, 196];
		this.tileArray["pillar_left"] = [16];
		this.tileArray["wall_corner_right_down"] = [35, 51, 163, 179];
		this.tileArray["wall_right_continue"] = [34, 162, 130];
		this.tileArray["wall_continue_left_corner"] = [64];
		this.tileArray["wall_continue_right_corner"] = [128];
		this.tileArray["wall_continue_left_corner_right"] = [120];
		this.tileArray["wall_continue_right_corner_left"] = [178];
		this.tileArray["wall_corner_right_corner_left"] = [194, 226];
				...
				if(map.tiles[x][y].type === 1) {
					...
					for(var index in this.tileArray) {
						...
						if(this.tileArray[index].indexOf(tileNumber) !== -1) {
							...
							var textureName = index+"_"+Utils.randomNumber(1, 2)+".png";

							var texture = PIXI.Texture.fromFrame(textureName);

							this.game.map.pixitiles[x][y].setTexture(texture);
