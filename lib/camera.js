...
Roguelike.Camera = function(game, position){
    ...
    */
    ...
    /*
    * @property {int} deadZoneX - The minimal distance from horizontal borders before the camera starts to move
    */
    this.deadZoneX = 0;

    /*
    * @property {int} deadZoneY - The minimal distance from vertical borders before the camera starts to move
    */
    this.deadZoneY = 0;
...
Roguelike.Camera.prototype = {
    ...
    * @param {int} deadZoneX - The minimal distance from horizontal borders before the camera starts to move
    * @param {int} deadZoneY - The minimal distance from vertical borders before the camera starts to move
    */
    follow: function(followObject, deadZoneX, deadZoneY){
