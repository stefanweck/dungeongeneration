...
Roguelike.MapFactory.prototype = {
    ...
    */
    generateHorizontalCorridor: function(x, y){
        ...
        if(this.game.map.tiles[y][x].type === 1 && this.game.map.tiles[y + 1][x].type === 1 && this.game.map.tiles[y - 1][x].type === 1 && Roguelike.Utils.randomNumber(1, 100) > 20){
            ...
            this.game.map.tiles[y][x].set(doorObject);
