...
Roguelike.EnemyFactory = {
	...
	newSkeleton: function(game, position) {
		...
		entity.addComponent(new Roguelike.Components.Tooltip(game.settings.canvas, "Skeleton", "Enemy", "The skeleton is a very dangerous but unstable enemy. If you stab just right his bones will collapse."));
