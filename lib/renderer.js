...
Roguelike.Renderer.prototype = {
        ...
        for(y = 0; y < this.game.map.tilesY; y++){
            ...
            for(x = 0; x < this.game.map.tilesX; x++){
                ...
                this.context.fillRect(
                    ...
                    (x * this.game.map.tileSize) - (this.game.camera.position.x * this.game.map.tileSize),
                    (y * this.game.map.tileSize) - (this.game.camera.position.y * this.game.map.tileSize),
    ...
    */
    drawPlayer: function(){
        ...
        this.context.fillRect(
            (this.game.player.position.x * this.game.map.tileSize) - (this.game.camera.position.x * this.game.map.tileSize),
            (this.game.player.position.y * this.game.map.tileSize) - (this.game.camera.position.y * this.game.map.tileSize),
            this.game.map.tileSize,
            this.game.map.tileSize
        );
